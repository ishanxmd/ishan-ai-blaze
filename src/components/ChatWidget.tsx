  ...
  return (
    <>
      <motion.button
        ...
        className="fixed bottom-6 right-6 z-50 px-5 h-12 rounded-full btn-color-shift flex items-center justify-center gap-2 glow-box-strong hover:opacity-90 transition-opacity"
        whileTap={{ scale: 0.95 }}
      >
