      ...
      <div className="container relative z-10 flex flex-col items-center text-center px-4 py-20">
        ...
        >
          <span className="relative inline-block">
            ...
            {/* Glitch layers */}
            <span className="absolute inset-0 text-rgb animate-[glitch-1_3s_infinite]" aria-hidden="true">ISHAN BETA MD</span>
            <span className="absolute inset-0 text-rgb animate-[glitch-2_3s_infinite]" aria-hidden="true">ISHAN BETA MD</span>
            {/* Underline scanner */}
