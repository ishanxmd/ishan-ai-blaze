          ...
          <div className="p-6 grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-3">
            {commands.map((cmd, i) => (
              <motion.div
                ...
                viewport={{ once: true }}
                className="px-3 py-2 rounded-md bg-secondary/80 border border-border/50 text-center font-mono text-sm text-blue-500 hover:border-primary/50 hover:bg-primary/10 transition-colors cursor-default"
              >
                {cmd}
              </motion.div>
            ))}
